  ...
  return (
    <>
      <div className="bg-[url('/img/giustizia.jpg')] md:bg-[url('/img/Header_img.avif')] relative w-full h-screen bg-cover bg-bottom bg-no-repeat md:bg-cover md:bg-center">
        ...
        <div className={`animatedDiv  z-20 bg-gradient-to-r border-black from-[#233c6d] to-[#03163d] shadow-lg rounded-r-sm flex items-center justify-center min-w-[180px] w-4/5 h-3/5 opacity-80 absolute top-16 left-0  transition-transform duration-1000 py-10 px-2 sm:h-4/5 lg:h-screen lg:w-1/2  lg:top-0 ${animate ? "-translate-x-0" : "-translate-x-full"}`}>
