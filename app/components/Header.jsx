...
useEffect(()=>{
  ...
  return (
    <>
      <div className="absolute w-full h-screen  bg-[url('/img/giustizia.jpg')] bg-contain bg-top  md:bg-[url('/img/Header_img.avif')] bg-no-repeat  lg:bg-cover lg:bg-center">
        <div className="absolute inset-0 bg-[#01102d] opacity-30  h-screen"></div>
